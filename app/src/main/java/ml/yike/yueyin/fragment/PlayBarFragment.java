...
import static ml.yike.yueyin.receiver.PlayerManagerReceiver.status;
...
public class PlayBarFragment extends Fragment {
    ...
    public static final String ACTION_UPDATE_UI_PlAYBAR = "ml.yike.yueyin.fragment.PlayBarFragment:action_update_ui_broad_cast";

    public static final String REMOTE_CANCEL_BROADCAST = "ml.yike.yueyin.remote_cancel";

    public static final String REMOTE_NEXT_BROADCAST = "ml.yike.yueyin.remote_next";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAlbum=(ImageView)view.findViewById(R.id.album_picture_iv);
        rAlbum=(ImageView)view.findViewById(R.id.remote_music_album_iv);
...
//      设置Popupwindow显示位置（从底部弹出）
    ...
    private void setMusicName() {
        int musicId = MyMusicUtil.getIntSharedPreference(Constant.KEY_ID);
        if (musicId == -1) {
            musicNameText.setText("yueMusic");
            singerNameText.setText("好音乐，悦耳动听！");
        } else {
    ...
    private void initAlbumImage() {
        Bitmap bitmap =PlayActivity.getBitmap();
        if (bitmap != null) {
...
//            rAlbum.setImageBitmap(bitmap);
        } else {
            mAlbum.setImageDrawable(getResources().getDrawable(R.mipmap.ic_launcher));
//            rAlbum.setImageDrawable(getResources().getDrawable(R.mipmap.ic_launcher));
        }
    }
