...
//                        new SweetAlertDialog(activity, SweetAlertDialog.WARNING_TYPE).setTitleText("温馨提示").setContentText("该歌单已存在该歌曲").show();
...
//                        new SweetAlertDialog(activity,SweetAlertDialog.SUCCESS_TYPE).setTitleText("温馨提示").setContentText("添加到歌单成功").show();
                    }
                    dismiss();
//                if (dataList.size() == 0){
//                    //添加歌单
